...
async def bop(VC: discord.VoiceChannel):
    ...
    boppage.play(discord.FFmpegPCMAudio(executable=r"C:\Users\monke\Documents\VSCode\ffmpeg\bin\ffmpeg.exe", source=r"C:\Users\monke\Documents\VSCode\Important\audio.mp3"))
